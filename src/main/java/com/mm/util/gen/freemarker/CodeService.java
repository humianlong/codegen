...
public class CodeService {
    ...
    public List<CodeFile> gencode(DatabaseWapper database, String taskName,
    ...
    public List<CodeFile> gencode(TableWapper table, String taskName, Map<String, Object> config)
            throws Exception {
